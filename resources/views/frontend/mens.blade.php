                ...
                <aside class="filters-sidebar" id="filtersSidebar">
                    ...
                    <form action="{{ url()->current() }}" method="GET" id="filterForm">
                                ...
                                <ul class="filter-list">
                                    <li class="filter-item">
                                        <label class="custom-checkbox">
                                            <input type="checkbox" name="category[]" value="dhoti">
                                            <span class="checkmark"></span>
                                            <span class="label-text">Pure Silk Dhotis</span>
                                        </label>
                                    </li>
                                    <!-- Simplified for brevity, will apply class to others -->
                                    <li class="filter-item">
                                        <label class="custom-checkbox">
                                            <input type="checkbox" name="category[]" value="shirt">
                                            <span class="checkmark"></span>
                                            <span class="label-text">Formal Shirts</span>
                                        </label>
                                    </li>
                                    <li class="filter-item">
                                        <label class="custom-checkbox">
                                            <input type="checkbox" name="category[]" value="kurta">
                                            <span class="checkmark"></span>
                                            <span class="label-text">Silk Kurtas</span>
                                        </label>
                                    </li>
                                    <li class="filter-item">
                                        <label class="custom-checkbox">
                                            ...
                                            <span class="checkmark"></span>
                                            <span class="label-text">Wedding Sets</span>
                                        </label>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="filter-group">
                            ...
                            <div class="filter-group-content">
                                <ul class="filter-list">
                                    ...
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Pure Cotton</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Linen</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Poly Silk</span></label></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="filter-group">
                            ...
                            <div class="filter-group-content">
                                <ul class="filter-list">
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Ivory / White</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Gold</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Maroon</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Navy Blue</span></label></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="filter-group">
                            ...
                            <div class="filter-group-content">
                                <ul class="filter-list">
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">S</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">M</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">L</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">XL</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">XXL</span></label></li>
                                </ul>
                            </div>
                        </div>
