    ...
    <main class="category-page">
        <div class="page-shell">
            <div class="breadcrumb">
                <a href="{{ route('home') }}">Home</a> &nbsp; / &nbsp; <span>Women's Collection</span>
            </div>
                ...
                <aside class="filters-sidebar" id="filtersSidebar">
                    ...
                    <form action="{{ url()->current() }}" method="GET" id="filterForm">
                        ...
                        <div class="filter-group">
                            ...
                            <div class="filter-group-content">
                                <ul class="filter-list">
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Salwar Materials</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Readymade Chudidhars</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Designer Blouses</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Ethnic Gowns</span></label></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="filter-group">
                            ...
                            <div class="filter-group-content">
                                <ul class="filter-list">
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Silk Cotton</span></label></li>
                                    ...
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Georgette</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Chiffon</span></label></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="filter-group">
                            ...
                            <div class="filter-group-content">
                                <ul class="filter-list">
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Turquoise</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Peach</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Lavender</span></label></li>
                                    <li class="filter-item"><label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span><span class="label-text">Emerald Green</span></label></li>
                                </ul>
                            </div>
                        </div>
