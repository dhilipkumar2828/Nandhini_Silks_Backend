...
@section('title', 'Create Tax Class')
...
<div class="max-w-4xl mx-auto">
    <div class="card-glass p-6 rounded-2xl">
        <div class="flex items-center mb-6">
            ...
            <h2 class="text-lg font-bold text-slate-800">Add New Tax Class</h2>
        </div>

        <form id="taxClassForm" action="{{ route('admin.tax-classes.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div class="space-y-1.5">
                ...
                <textarea name="description" rows="3"
                    ...
                    placeholder="Describe this tax class...">{{ old('description') }}</textarea>
            </div>
