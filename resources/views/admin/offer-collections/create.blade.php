...
@section('title', 'Add Offer Collection')
...
<div class="max-w-4xl mx-auto">
    <div class="card-glass p-6 rounded-2xl bg-white shadow-sm">
        <h2 class="text-lg font-bold text-slate-800 mb-6 flex items-center">
            <i class="fas fa-plus-circle mr-2 text-[#a91b43]"></i> Add New Offer Collection
        </h2>

        <form action="{{ route('admin.offer-collections.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="name" id="collectionName" value="{{ old('name') }}" required
