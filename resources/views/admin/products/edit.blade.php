                            ...
                            <div class="flex flex-wrap gap-2 mb-2">
                                ...
                                @if($images && count($images) > 0)
                                    @foreach($images as $img)
                                        <img src="{{ asset('uploads/' . $img) }}" class="w-16 h-16 rounded-lg object-cover border border-slate-100 shadow-sm">
                                    @endforeach
                                @endif
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="regular_price" step="0.01" value="{{ old('regular_price', $product->regular_price) }}" required
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="number" name="discount_percent" id="discount_percent" step="0.01" value="{{ old('discount_percent', $product->discount_percent) }}"
                                class="w-full bg-slate-50 border border-slate-200 px-3 py-2 rounded-lg text-sm outline-none focus:border-[#a91b43] transition-all text-slate-800">
                        </div>
                        <div class="space-y-1.5">
