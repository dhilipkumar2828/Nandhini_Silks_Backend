            ...
            <div id="variantConfigurationSection" class="{{ old('is_variant') ? '' : 'hidden' }} space-y-6">
                <div class="card-glass p-8 rounded-[2.5rem] border-2 border-[#a91b43]/10 shadow-2xl relative overflow-hidden bg-white">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
                        <div class="md:col-span-1 pr-6 border-r border-slate-100">
                             <div class="p-6 bg-slate-50/80 rounded-3xl border-2 border-slate-100/50">
                                <label class="block text-[11px] font-black text-slate-800 uppercase tracking-widest mb-4 flex items-center gap-2">
                                    <i class="fas fa-sliders-h text-[#a91b43]"></i> Setup Attributes
                                </label>
                                ...
                                <div id="activeAttributeRows" class="mt-8 space-y-5">
                                    @foreach($attributes as $attribute)
                                        <div id="attr_row_{{ $attribute->id }}" class="hidden-attr-row hidden p-5 bg-white rounded-3xl border-2 border-slate-100 relative shadow-sm">
                                            ...
                                            <label class="block text-[10px] font-black text-slate-800 uppercase tracking-widest mb-3 uppercase tracking-tight">
                                                {{ $attribute->name }}
                                            </label>
                        ...
                        <div class="md:col-span-3">
                            ...
                            <div id="matrixPlaceholder" class="flex flex-col items-center justify-center p-20 border-4 border-dashed border-slate-50 rounded-[3rem] bg-slate-50/20 text-slate-300">
                                <i class="fas fa-th-large text-4xl mb-4 text-rose-100"></i>
                                <h4 class="text-base font-black text-slate-700">Add attributes to generate variations.</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <tr class="border-b border-slate-50">
                    ...
                    <td class="px-1 py-4">
                        <div class="flex flex-col items-center gap-1">
                            ...
                            <div class="v-preview-container flex flex-wrap justify-center gap-1">${ui ? ui.preview : ''}</div>
                        </div>
                    </td>
